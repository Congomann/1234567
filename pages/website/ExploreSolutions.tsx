      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          <h1 className="text-5xl md:text-7xl font-black text-slate-900 mb-6 tracking-tight">
            Explore <span className="text-slate-600">Solutions.</span>
          </h1>
          ...
          {categories.map((cat, idx) => (
            <div key={idx} className="space-y-10">
              <div>
                ...
                <div className="h-1 w-12 bg-slate-600 mt-4"></div>
              </div>
              ...
              <div className="space-y-4">
                {cat.items.map((item, i) => (
                  ...
                  >
                    <div className="mt-1 p-3 bg-white rounded-2xl shadow-md text-slate-400 group-hover:text-slate-600 group-hover:shadow-slate-100 transition-all">
                      <item.icon size={24} />
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-lg font-bold text-slate-900 group-hover:text-slate-600 transition-colors">{item.label}</span>
        ...
        <div className="mt-32 relative overflow-hidden bg-[#0c0d12] rounded-[3rem] p-12 md:p-20 text-white shadow-2xl shadow-slate-900/20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-600/30 backdrop-blur-md rounded-full text-slate-300 text-[10px] font-black uppercase tracking-widest mb-8 border border-slate-500/30">
              ...
              <p className="text-xl text-slate-100/80 mb-10 leading-relaxed font-medium">
                Connect with an expert advisor who can build a custom financial roadmap designed specifically for your goals.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  to="/advisors"
                  className="bg-white text-[#0c0d12] hover:bg-slate-100 px-8 py-4 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-xl shadow-slate-900/10"
                >
                  Find Advisor <ArrowRight size={16} />
                </Link>
                <Link 
                  to="/contact"
                  className="bg-slate-600/20 backdrop-blur-md border border-white/10 text-white hover:bg-white/10 px-8 py-4 rounded-2xl font-bold text-sm flex items-center justify-center transition-all"
                >
                  Contact Support
                </Link>
              </div>
            ...
            <div className="hidden lg:block w-96 h-96 relative">
              <div className="absolute inset-0 bg-slate-400 rounded-[3rem] rotate-6 opacity-10"></div>
              <div className="absolute inset-0 bg-slate-500 rounded-[3rem] -rotate-3 opacity-20 animate-pulse"></div>
              <div className="absolute inset-0 bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] flex flex-col items-center justify-center p-12 text-center">
                <div className="w-20 h-20 bg-slate-600 rounded-3xl flex items-center justify-center mb-8 shadow-2xl shadow-slate-600/50">
                  <TrendingUp size={40} />
                </div>
                <h3 className="text-2xl font-black mb-4">Total Value</h3>
                <p className="text-5xl font-black text-slate-400">$2.4M+</p>
                <p className="text-sm text-slate-200/60 mt-4 font-bold uppercase tracking-widest">Client Assets Managed</p>
              </div>
            </div>
          </div>
        </div>
