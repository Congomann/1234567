    ...
    <div className="bg-slate-50 min-h-screen pt-32 pb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {mortgageTypes.map((type, index) => {
            ...
            return (
              ...
              >
                <div className="absolute top-0 right-0 p-10 text-slate-100 font-black text-8xl opacity-10 group-hover:text-slate-500/10 transition-colors pointer-events-none">
                  {index + 1}
                </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 mb-8">
        <div className="bg-[#0c0d12] text-slate-300 rounded-3xl p-8 border border-slate-800 flex flex-col md:flex-row items-center gap-6 shadow-xl">
          <div className="p-4 bg-slate-500/10 text-slate-400 rounded-2xl shrink-0 border border-slate-500/20">
