        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-2xl px-6 py-4 font-bold text-slate-900 focus:outline-none focus:ring-4 ring-slate-500/10 transition-all"
                    />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-600 rounded-[3rem] p-10 text-white shadow-2xl relative overflow-hidden group">
              ...
              <a href="tel:800-555-0199" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest bg-white text-slate-600 px-6 py-3 rounded-full hover:bg-slate-50 transition-colors">
                Call Support
              </a>
            </div>
          </div>
