...
interface RealEstateRecommenderModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const RealEstateRecommenderModal: React.FC<
  RealEstateRecommenderModalProps
> = ({ isOpen, onClose }) => {
  ...
  const customerNeeds = [
    {
      ...
      suggestion: "?view=buyers",
    },
    {
      id: "sell",
      label: "I want to sell my current property",
      suggestion: "?view=sellers",
    },
    {
      id: "invest",
      label: "I am looking for real estate investment opportunities",
      suggestion: "?view=properties",
    },
    {
      id: "browse",
      label: "I just want to browse available properties",
      suggestion: "?view=properties",
    },
  ];
  ...
  const handleSelect = (suggestion: string) => {
    onClose();
    navigate(`/real-estate${suggestion}`);
  };
