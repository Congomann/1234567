...
interface BusinessInsuranceRecommenderModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const BusinessInsuranceRecommenderModal: React.FC<
  BusinessInsuranceRecommenderModalProps
> = ({ isOpen, onClose }) => {
  ...
  const handleSelect = (suggestion: string) => {
    onClose();
    navigate(`/business-insurance#${suggestion}`);
  };
