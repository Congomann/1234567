...
interface AutoInsuranceRecommenderModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const AutoInsuranceRecommenderModal: React.FC<
  AutoInsuranceRecommenderModalProps
> = ({ isOpen, onClose }) => {
  ...
  const handleSelect = (suggestion: string) => {
    onClose();
    navigate(`/auto-insurance#${suggestion}`);
  };
