...
interface LifeInsuranceRecommenderModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export const LifeInsuranceRecommenderModal: React.FC<
  LifeInsuranceRecommenderModalProps
> = ({ isOpen, onClose }) => {
  ...
  const handleSelect = (suggestion: string) => {
    onClose();
    navigate(`/life-insurance#${suggestion}`);
  };
