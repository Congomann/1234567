...
const startTag = '{activeApplication ? (';
const endTag = ') : (';

const startIndex = content.indexOf(startTag);

// We need to find the specific `) : (` that closes the `{activeApplication ? (` block.
// Since it's JSX, we can search for `      ) : (` at the exact indentation level.
