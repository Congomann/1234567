...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RootEmbeddedApi.PrefillRequestParameters();
  });
  ...
  describe('PrefillRequestParameters', function() {
    it('should create an instance of PrefillRequestParameters', function() {
      // uncomment below and update the code to test PrefillRequestParameters
      //var instance = new RootEmbeddedApi.PrefillRequestParameters();
      //expect(instance).to.be.a(RootEmbeddedApi.PrefillRequestParameters);
    });
