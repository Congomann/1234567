...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RootEmbeddedApi.PolicyPaymentMethod();
  });
  ...
  describe('PolicyPaymentMethod', function() {
    it('should create an instance of PolicyPaymentMethod', function() {
      // uncomment below and update the code to test PolicyPaymentMethod
      //var instance = new RootEmbeddedApi.PolicyPaymentMethod();
      //expect(instance).to.be.a(RootEmbeddedApi.PolicyPaymentMethod);
    });
