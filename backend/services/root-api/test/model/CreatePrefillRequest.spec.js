...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RootEmbeddedApi.CreatePrefillRequest();
  });
  ...
  describe('CreatePrefillRequest', function() {
    it('should create an instance of CreatePrefillRequest', function() {
      // uncomment below and update the code to test CreatePrefillRequest
      //var instance = new RootEmbeddedApi.CreatePrefillRequest();
      //expect(instance).to.be.a(RootEmbeddedApi.CreatePrefillRequest);
    });
