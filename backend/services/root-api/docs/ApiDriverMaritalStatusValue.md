# RootEmbeddedApi.ApiDriverMaritalStatusValue
...
**requirements** | [**[ApiDriverGenderValueRequirementsInner]**](ApiDriverGenderValueRequirementsInner.md) | A list of requirements that must be met for this value to be valid. | 
